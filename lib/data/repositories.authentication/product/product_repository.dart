...
class ProductRepository extends GetxController {
  ...
  Future<List<ProductModel>> getProductsForBrand(
    ...
    try {
      ...
      final products =
      querySnapshot.docs.map((doc) => ProductModel.fromSnapshot(doc)).toList();
  ...
  Future<List<ProductModel>> getProductsForSubCategory(
    ...
    try {
      ...
      final productCategoryQuery = limit == -1
          ? await _db.collection('ProductCategory').where('LevelId', isEqualTo: categoryId).get()
          : await _db.collection('ProductCategory').where('LevelId', isEqualTo: categoryId).limit(limit).get();
