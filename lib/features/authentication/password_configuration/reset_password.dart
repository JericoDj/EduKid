      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              /// Image
              Image(image: const AssetImage(MyImages.resetPasswordGIF), width: MyHelperFunctions.screenWidth()* 0.6,),
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(onPressed: () => Get.off(() =>  LoginScreen()),
                    child: const Text("Submit"),)),
              const SizedBox(height:  MySizes.spaceBtwItems),
              SizedBox(
                  width: double.infinity,
                  child: TextButton(onPressed: () => ForgetPasswordController.instance.sendPasswordResetEmail(),
