...
import 'package:edukid/features/shop/controller/product/variation_controller.dart';
...
// Get selected Variation if any...
  ...
  void saveCartItems() {
    ...
    MyStorageUtility.instance().saveData('cartItems', cartItemStrings);
  }

  void loadCartItems() {
    final cartItemStrings =
        MyStorageUtility.instance().readData<List<dynamic>>('cartItems');
